...
class VoronoiNoise: CIFilter {
    ...
    override var outputImage: CIImage? {
        return voronoiKernel.apply( extent: CGRect(origin: CGPoint.zero, size: CGSize(width: inputWidth, height: inputHeight)), arguments: [inputSeed, inputSize, inputDensity])
    }
}
