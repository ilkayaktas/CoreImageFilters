...
class CircularBokeh: CIFilter, VImageFilter {
    ...
    override var outputImage: CIImage? {
        ...
        let imageRef = ciContext.createCGImage( inputImage, from: inputImage.extent)
        
        var imageBuffer = vImage_Buffer()
        
        vImageBuffer_InitWithCGImage(&imageBuffer, &format, nil, imageRef!, UInt32(kvImageNoFlags))
...
class EndsInContrastStretch: CIFilter, VImageFilter {
    ...
    lazy var ciContext: CIContext = { return CIContext() }()
